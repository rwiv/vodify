...
from ..service.stdl.transcoder import StdlTranscoder, create_stdl_accessor
...
class WorkerDependencyManager:
    ...
    def create_stdl_transcoder(self, src_fs_name: str) -> StdlTranscoder:
        ...
        return StdlTranscoder(
            accessor=create_stdl_accessor(fs_name=src_fs_name, fs_configs=fs_configs, env=env),
            notifier=notifier,
